...
public class AttrRuntimeVisibleTypeAnnotations extends AttributeInfo {

    public AttrRuntimeVisibleTypeAnnotations(int attribute_name_index, int attribute_length) {
