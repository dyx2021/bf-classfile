...
public class AttrLocalVariableTypeTable extends AttributeInfo {

    public AttrLocalVariableTypeTable(int attribute_name_index, int attribute_length) {
        super(attribute_name_index, attribute_length);
    }
    private int local_variable_type_table_length;
    private List<LocalVariableTypeTableInfo> local_variable_type_table = new ArrayList<>();
    ...
    public List<LocalVariableTypeTableInfo> getLocal_variable_type_table() {
        return local_variable_type_table;
    }

    public void setLocal_variable_type_table(List<LocalVariableTypeTableInfo> local_variable_type_table) {
