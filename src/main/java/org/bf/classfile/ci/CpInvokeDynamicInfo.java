...
public class CpInvokeDynamicInfo extends CpInfo {
    private int bootstrap_method_attr_index; // bootstrap_methods array index
    private int name_and_type_index; // CONSTANT_NameAndType_info
