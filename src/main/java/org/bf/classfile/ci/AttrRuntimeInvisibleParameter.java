...
public class AttrRuntimeInvisibleParameter extends AttributeInfo {

    public AttrRuntimeInvisibleParameter(int attribute_name_index, int attribute_length) {
    ...
    public String toString() {
        return "AttrRuntimeInvisibleParameter{" +
